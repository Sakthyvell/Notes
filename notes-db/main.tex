...
\title{Sakthy re-learns DB stuff properly}
...
\section{Motivation}
I know SQL but do I really \textbf{know} SQL? I have been able to get by with basic queries and I even know how advanced concepts like indexing, normalization, and transactions. However, I feel like my understanding is superficial. I want to understand how it works under the hood and when to use what. I have debugged numerous issues in the past but when I think about them now, I can't seem to recall the exact details. So this document is my personal journey to re-learn and deeply understand database concepts.

\section{Understanding SQL query cost}
...
\subsection{Case 1: EXPLAIN ANALYZE statement}
...
\subsubsection{Analyzing the EXPLAIN output}
...
&\quad + (\texttt{index\_lookups} \times \texttt{key\_lookup\_cost}) + \ldots
\end{align*}
